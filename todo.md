...
- [x] Investigar e corrigir o erro de codificação ASCII ao criar uma conta no Supabase via Streamlit.
- [ ] Validar o fluxo de criação e login de usuário após a correção.
- [ ] Enviar a correção ao GitHub e confirmar a atualização no Streamlit Cloud.
